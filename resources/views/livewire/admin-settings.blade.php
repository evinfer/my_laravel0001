<div>
                              ...
                              <div class="tab">
									<ul class="nav nav-tabs customtab" role="tablist">
										<li class="nav-item">
											<a wire.click.prevent='selectTab("genaral_settings")' class="nav-link
                                            {{ $tab == 'genaral_settings' ? 'active' : '' }}" data-toggle="tab" 
										...
										<li class="nav-item">
                                            ...
                                            {{ $tab == 'logo_favicon' ? 'active' : '' }}" data-toggle="tab" 
                                            href="#logo_favicon" role="tab" aria-selected="true">Logo & favicon</a>
										</li>
										<li class="nav-item">
											<a wire.click.prevent='selectTab("social_networks")' class="nav-link
                                            {{ $tab == 'social_networks' ? 'active' : '' }}" data-toggle="tab" 
                                        ...
                                        <li class="nav-item">
                                            ...
                                            {{ $tab == 'payment_methods' ? 'active' : '' }}" data-toggle="tab" 
                                            href="#payment_methods" role="tab" aria-selected="false">Payment methods</a>
										</li>
									</ul>
									<div class="tab-content">
										<div class="tab-pane fade {{ $tab == 'genaral_settings' ? 'active show' : '' }}" 
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                placeholder="Enter site name" wire:model.defer='site_name'>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" 
                                                                placeholder="Enter site email" wire:model.defer='site_email'>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" 
                                                                placeholder="Enter site phone" wire:model.defer='site_phone'>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" 
                                                                placeholder="Enter site meta keywords" wire:model.defer='site_meta_keywords'>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" wire:model.defer='lnkedin_url' 
                                        ...
                                        id="payment_methods" role="tabpanel">
											<div class="pd-20">
                                            -------------------Payment methods------------------------
											</div>
										</div>
