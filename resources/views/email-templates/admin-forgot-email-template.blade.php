<p>Dear {{ $admin->name }}</p>
<p>
    We are received a request to reset the password for laravel account associated with {{$admin->email}},
    ...
    box-shadow:0 2px 3px rgb(0,0,0,0.16);-webkit-text-size-ajust:none;box-sizing:border-box;">Reset password</a>
    <br>
