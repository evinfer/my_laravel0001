...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>@yield('Cyberclashpunk')</title>
		...
		<link rel="stylesheet" href="/extra-assets/ijaboCropTool/kropify.min.css">
        @livewireStyles
		@stack('stylesheets')
	</head>
	<body>
		...
		<script src="/extra-assets/ijaboCropTool/kropify.min.js"></script>
		<script>
